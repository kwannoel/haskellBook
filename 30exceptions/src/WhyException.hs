...
-- About the typeable class: dynamic typechecking
-- learn the type of a value at runtime and compaare the types of two values

-- when exceptions are thrown they then roll back through the stack looking for a catch to handle
